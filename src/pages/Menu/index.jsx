...
export default function index() {
  ...
  return (
    <div className={styles.menu}>
      ...
      <MainButton className={styles.btn1} text={text1} height={height} width={width} onClick={handleSolo} />
      <MainButton className={styles.btn2} text={text2} height={height} width={width} onClick={handleFriend} />
    </div>
  )
}
